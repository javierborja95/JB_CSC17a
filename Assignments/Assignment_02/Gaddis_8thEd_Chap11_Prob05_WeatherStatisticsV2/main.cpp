...
//Function Prototypes
void getWther(Weather[]);
void display(Weather[],float,float,float,float,float,int,int);
void getStat(Weather[],float&,float&,int&,int&,float&,float&,float&);
void month(int);
//Execution
...
void getStat(Weather a[],float &high,float &low,int &hMonth,int &lMonth,
...
void display(Weather a[],float tR,float aR,float aT,float h,float l,
        int hM, int lM){
    //Output Data
